...
export default async function ContactsPage({
  ...
  // Activo por defecto: se desactiva solo cuando has_linkedin=0
  if (params.has_linkedin !== "0") query = query.not("linkedin_url", "is", null).neq("linkedin_url", "");
  ...
  function buildPageUrl(p: number) {
    ...
    if (params.has_linkedin === "0") sp.set("has_linkedin", "0");
      ...
      <main className="max-w-full px-4 py-8 space-y-4">
        ...
        {!people || people.length === 0 ? (
          <div className="bg-white border border-gray-200 rounded-xl text-center py-16 text-sm text-gray-400">
            {count === 0 && !params.q && !params.org && !params.rol && !params.status && !params.location && params.has_linkedin !== "0"
